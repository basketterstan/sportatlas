      ...
      <div className="bg-ha-surface border border-ha-line rounded-2xl w-full max-w-md shadow-2xl overflow-hidden">
        ...
        {submitted ? (
          <div className="p-8 text-center">
            ...
            <button onClick={onClose} className="px-6 py-2.5 bg-ha-brand text-white rounded-ha-md font-medium hover:opacity-90 transition-opacity">
              Sluiten
            </button>
          </div>
          ...
          <>
            ...
            <div className="px-6 pt-4 pb-2">
              ...
              <p className="text-ha-textMid text-sm mb-3">
              ...
              <div className="bg-ha-surface2 border border-ha-line rounded-xl p-3 text-[11px] text-ha-textMid leading-relaxed mb-4">
                ...
                <ul className="list-disc list-inside space-y-0.5">
                  <li>Enkel voor <strong>jaarlijks Pro</strong> afgesloten in <strong>juli 2026</strong></li>
                  <li>Uitsluitend voor bezorgadressen <strong>binnen Europa</strong></li>
                  <li>Eén shirt per account · Zolang voorraad strekt</li>
                  <li>Verzending binnen 4 weken na bevestiging</li>
                </ul>
              </div>
            </div>
            <form onSubmit={handleSubmit} className="px-6 pb-6 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-xs font-medium text-ha-textMid mb-1">Land (Europa)</label>
